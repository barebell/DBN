...
class DBN(object):
    ...
    def pretrain(self, sess, batch_size=64, pretraining_epochs=10, lr=0.1, k=1, 
                    display_step=1):
        """
...
if __name__ == "__main__":
    ...
    images, labels = DBN_input.distorted_inputs(batch_size=64)
    dbn = DBN(n_in=24300, n_out=6, hidden_layers_sizes=[500, 500, 500])
