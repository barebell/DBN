...
def read_cifar10(filename):
  ...
  """
  filename_queue = tf.train.string_input_producer(["train1.bin","train2.bin","train3.bin"])
...
def distorted_inputs(batch_size):
  ...
  bin_images = tf.reshape(float_image,[-1])
  ...
  return _generate_image_and_label_batch(bin_images, read_input.label,
